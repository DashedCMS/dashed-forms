...
class FormInputsExportMail extends Mailable
{
    ...
    {
        $view = view()->exists(config('dashed-core.site_theme', 'dashed') . '.emails.exported-form-inputs') ? config('dashed-core.site_theme', 'dashed') . '.emails.exported-form-inputs' : 'dashed-forms::emails.exported-form-inputs';
