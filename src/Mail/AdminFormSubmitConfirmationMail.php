...
class AdminFormSubmitConfirmationMail extends Mailable implements RegistersEmailTemplate, SendsToTelegram
{
    ...
    {
        return 'Verzonden naar de beheerder als een formulier is ingediend.';
    }
     ...
     */
    public static function cmsUrlFor(Form $form, FormInput $formInput): string
    {
        try {
    ...
    public static function sampleData(): array
    {
        ...
        return [
            ...
            'cmsUrl' => $form && $formInput ? self::cmsUrlFor($form, $formInput) : (string) config('app.url'),
        ];
    }
    ...
    public function build()
    {
        $context = [
            ...
            'siteName' => Customsetting::get('site_name'),
            'cmsUrl' => self::cmsUrlFor($this->form, $this->formInput),
        ];
        ...
        $formSubject = $this->form->resolveMailSubject('admin', $this->formInput);
