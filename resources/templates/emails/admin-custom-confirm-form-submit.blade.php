                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <div
                                                                    ...
                                                                    {{Translation::get('admin-form-confirmation-' . Str::slug($formInput->form->name) . '-email-title', 'forms', 'Er is een formulier ingevuld!')}}
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left" class="link-wrap"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <br>
                                                                    {!! nl2br(Translation::get('admin-form-confirmation-' . Str::slug($formInput->form->name) . '-email-content', 'forms', 'Probeer binnen 2 werkdagen te reageren.', 'textarea')) !!}
                                                                    <hr>
                                                                    ...
                                                                    <tr>
                                                                        <td align="center"
                                                                            ...
                                                                            valign="middle"><a
                                                                                ...
                                                                                target="_blank"> {{Translation::get('admin-form-confirmation-' . Str::slug($formInput->form->name) . '-email-view-button', 'orders', 'Bekijk formulier')}} </a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
