                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <div
                                                                    ...
                                                                    {{Translation::get('form-confirmation-' . Str::slug($formInput->form->name) . '-email-title', 'forms', 'We hebben je aanvraag ontvangen!')}}
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left" class="link-wrap"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <br>
                                                                    {!! nl2br(Translation::get('form-confirmation-' . Str::slug($formInput->form->name) . '-email-content', 'forms', 'We proberen binnen 2 werkdagen te reageren.', 'textarea')) !!}
                                                                    <hr>
